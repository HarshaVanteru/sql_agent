...
from .schemas import LoginRequest, LoginResponse, MFARequiredResponse, UserSummary, RefreshTokenRequest, RefreshTokenResponse
...
async def refresh_access_token(
    ...
    for session in sessions:
        if token_svc.verify_refresh_token(body.refresh_token, session.refresh_token_hash):
