...
Configured exactly once, at application startup (app/main.py). Everything
...
from app.core.config import settings  # noqa: F401  -- loads .env before LOGFIRE_* is read
...
def configure_observability() -> None:
    ...
    # (app/query/databases/engines.py), which are created on demand.
